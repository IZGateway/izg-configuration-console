...
This will run the Docker image for IZG CC (which has Nginx — provided by the `ghcr.io/izgateway/alpine-node-openssl-fips` base image — and the application) as well as a MySQL image loaded with dummy test data.
