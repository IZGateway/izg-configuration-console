# allowed-user-audit-logging Specification

## Purpose

Defines how AllowedUser (Onboarding Senders) create/update operations report their change type
in audit log events so that the value is consistent across layers and filterable in Elastic, while
leaving the persisted DynamoDB audit record unchanged.
