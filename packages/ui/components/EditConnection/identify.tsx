...
const Identify = (props: any) => {
  ...
  const formFields = [
    { id: "facilityId", name: "facility_id", label: "Facility ID", value: props.value.facility_id, group: 1 },
    { id: "msh4", name: "MSH4", label: "MSH-4", value: props.value.MSH4, group: 1 },
    { id: "msh6", name: "MSH6", label: "MSH-6", value: props.value.MSH6, group: 1 },
    { id: "msh3", name: "MSH3", label: "MSH-3", value: props.value.MSH3, group: 2 },
    { id: "msh5", name: "MSH5", label: "MSH-5", value: props.value.MSH5, group: 2 },
    { id: "msh22", name: "MSH22", label: "MSH-22", value: props.value.MSH22, group: 2 },
    { id: "rxa11", name: "RXA11", label: "RXA-11", value: props.value.RXA11, group: 3 },
    { id: "new-password", name: "newPassword", label: "New Password", value: props.value.newPassword, group: 4 },
  ...
  return (
    <form>
      ...
      <Card sx={{ minWidth: 275, borderRadius: "0px 0px 30px 30px", marginTop: 5 }}>
        ...
        <CardContent>
          <div>
            All MSH and facility ID values should be between 0-25 characters and Should contain only A-Z, a-z, 0-9, _, -, and space characters. It should not contain |^&~"/ characters. If you think a value is incorrect, please contact your administrator
          </div>
