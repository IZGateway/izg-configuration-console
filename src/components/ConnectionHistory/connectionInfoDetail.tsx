              ...
              >
                ...
                >
                  <TextField
                    ...
                    variant="filled"
                    disabled
                    defaultValue={destination.username}
                    InputProps={{
                      readOnly: true,
                    }}
                    fullWidth
                ...
                >
                  <TextField
                    ...
                    variant="filled"
                    disabled
                    defaultValue={destination.MSH22}
                    InputProps={{
                      readOnly: true,
                    }}
                    fullWidth
                  ...
                  <TextField
                    ...
                    variant="filled"
                    disabled
                    defaultValue={destination.RXA11}
                    InputProps={{
                      readOnly: true,
                    }}
                    fullWidth
